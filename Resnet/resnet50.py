...
def train(resume=False):
    ...
    optimizer = torch.optim.Adam(model.parameters(), lr=1e-5, weight_decay=1e-4)  # Reduced learning rate and added weight decay
    ...
    start_epoch = 1
    if resume:
        if os.path.exists("resnet_checkpoint_test_2.pth.tar"):
            checkpoint = load_checkpoint("resnet_checkpoint_test_2.pth.tar")
    ...
    for epoch in range(start_epoch, num_epochs + 1):
        ...
        save_checkpoint(checkpoint, file_name="resnet_checkpoint_test_3.pth.tar")
